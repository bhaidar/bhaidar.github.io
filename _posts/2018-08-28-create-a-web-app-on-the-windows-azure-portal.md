...
This article provides you with a thorough guidance on how to use the Azure Portal to create your Web app **Container** that will ultimately host your Web app.  
